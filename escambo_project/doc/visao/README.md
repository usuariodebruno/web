...
| :-----------------: | :-----------------: | :-----------------: | :-----------------: |
| 24 de Abril de 2023| 1.0 | Versão inicial |  Bruno Almeoda |
| - | - | - |  - |
...
|     |      |
| --- | --- |
| **Problema**            | Pessoas que estão procurando uma maneira de obter roupas, acessórios ou tênis sem ter que gastar dinheiro diretamente. |
| **Afeta**               | Pessoas que estão buscando formas de otimizar seu dinheiro, desfazer de produtos insatisfatórios e que não possuem  maturidade na hora de comprar roupas e produtos diversos. |  
| **Impacta**             | A plataforma Escambo pode ter um impacto positivo na economia, no meio ambiente e na comunidade, incentivando a sustentabilidade e a conscientização sobre os problemas da indústria, principalmente, da moda. |
| **Solução**             | Uma  plataforma para escambo de roupas e acessórios, que estejam em bom estado, onde os usuários possam postar suas peças de vestuário e a plataforma promover a conexão entre pessoas com interesses semelhantes e criar uma comunidade em torno da moda sustentável e da troca de roupas. | 

## 3. Descrição dos usuários 

| Nome              |  Descrição               |          Responsabilidades  |
| :-----------------: | :-----------------: | :-----------------: |
| ***Administradores do sistema*** | usuários responsáveis pela gestão e manutenção da plataforma, incluindo a verificação de conteúdo publicado, monitoramento de atividades e solução de problemas técnicos | - Gerenciar a estrutura do sistema <br> - Gerenciar a segurança do sistema <br> - Monitorar as atividades dos usuários <br> - Gerenciar o suporte técnico <br> - Manter a privacidade e segurança dos dados dos usuário |
| ***Usuários registrados*** | Pessoas que criam uma conta na plataforma para poderem publicar seus itens disponíveis para troca, visualizar o catálogo de itens de outros usuários e iniciar conversas com potenciais parceiros de troca. | - Utilizar o sistema de forma adequada e de acordo com as políticas e diretrizes da plataforma<br>- postar itens disponíveis para troca<br>- conectar-se com potenciais parceiros de escambo<br>- usar o sistema para realizar transações justas e transparentes,  sem tentar beneficiar ou prejudicar injustamente outros usuários<br>- relatar comportamentos inadequados ou suspeitos aos administradores do sistema<br>- garantir que os itens oferecidos para troca estejam em boas condições e de acordo com as políticas e diretrizes da plataforma. |
| ***Usuários visitantes*** | Pessoas apenas visualizam os itens disponíveis para trocas e querem ter uma ideia de como funciona a plataforma | - Utilizar a plataforma de forma sensata e moral<br>- Informar a equipe de suporte da plataforma sobre quaisquer problemas ou atividades impróprias<br>- Se você planeja se registrar como usuário no futuro, acompanhe as atualizações e modificações na plataforma |

## 4. Descrição do ambiente dos usuários

Pessoas envolvidas na troca de roupas na plataforma Escambo podem variar dependendo da escolha do usuário-alvo de fazer mais de uma troca simultaneamente ou de contar com ajuda de amigos ou familiares na seleção das peças disponíveis. Além disso, o número de usuários-alvo da plataforma pode aumentar ou diminuir ao longo do tempo, o que também pode influenciar na quantidade de pessoas envolvidas na execução das tarefas.

O ciclo de troca de roupas na plataforma Escambo pode variar em duração, dependendo da disponibilidade dos usuários em postar e escolher peças para troca. A quantidade de produtos listados, o volume de interações com potenciais parceiros comerciais e o tempo necessário para enviar e receber os itens de vestuário também podem afetar o tempo gasto em cada atividade. Dessa forma, a duração do ciclo da tarefa e o tempo podem sofrer alterações.

Para garantir uma experiência de usuário eficaz na plataforma Escambo, é essencial considerar as restrições ambientais exclusivas, como conexão de internet, navegadores web, dispositivos e idiomas. Esses fatores são importantes para assegurar a acessibilidade e a usabilidade da plataforma para todos os usuários.
...
***Localização das publicações:*** Os usuários podem filtrar itens de troca dependendo de sua localização geográfica usando geolocalização, que promove a troca local.
